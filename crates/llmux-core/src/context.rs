...
const CONTEXT_TABLE: &[(&str, u64)] = &[
    ...
    ("command-r", 131_072),
    ("yi-lightning", 16_384),
    // ── Command Code GOAT (verified 2026-08-21 https://commandcode.ai/docs/plans/goat) ──
    //   Opencode (opencode.ai/zen) data comes from GET {base_url}/models
